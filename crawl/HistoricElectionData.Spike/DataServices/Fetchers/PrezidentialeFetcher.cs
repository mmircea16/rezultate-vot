...
{
    public class PrezidentialeFetcher : ElectionFetcher
    {
        public PrezidentialeFetcher(Election election) : base(election) { }

        protected override void PopulateSummary()
        {
            var electionSummariesTask = HttpClient.GetStringAsync(
                $"http://alegeri.roaep.ro/wp-content/plugins/aep/aep_data.php?name=v1_prez_Tara_Sumar&parameter={Election.Id}"
            );
        ...
        protected override void PopulateGeneralResults()
        {
            var candidatesDataTask = HttpClient.GetStringAsync(
                $"http://alegeri.roaep.ro/wp-content/plugins/aep/aep_data.php?name=v1_prez_Tara_Voturi&parameter={Election.Id}"
            );
        ...
        protected override void GetCounties()
        {
            var countiesTask = HttpClient.GetStringAsync(
                $"http://alegeri.roaep.ro/wp-content/plugins/aep/aep_data.php?name=v1_prez_Judet_Lista&parameter={Election.Id}"
            );
        ...
        {
            var countiesTask = HttpClient.GetStringAsync(
                $"http://alegeri.roaep.ro/wp-content/plugins/aep/aep_data.php?name=v1_prez_Judet_Sumar&parameter={Election.Id}&parameter={idCounty}"
            );
        ...
        {
            var candidatesDataTask = HttpClient.GetStringAsync(
                $"http://alegeri.roaep.ro/wp-content/plugins/aep/aep_data.php?name=v1_prez_Judet_Voturi&parameter={Election.Id}&parameter={idCounty}"
            );
        ...
        private void GetCountyLocalities(int idCounty)
        {
            var localitiesTask = HttpClient.GetStringAsync(
                $"http://alegeri.roaep.ro/wp-content/plugins/aep/aep_data.php?name=v1_prez_Localitate_Lista&parameter={Election.Id}&parameter={idCounty}"
            );
        ...
        {
            var localitiesTask = HttpClient.GetStringAsync(
                $"http://alegeri.roaep.ro/wp-content/plugins/aep/aep_data.php?name=v1_prez_Localitate_Sumar&parameter={Election.Id}&parameter={idLocality}"
            );
        ...
        {
            var candidatesDataTask = HttpClient.GetStringAsync(
                $"http://alegeri.roaep.ro/wp-content/plugins/aep/aep_data.php?name=v1_prez_Localitate_Voturi&parameter={Election.Id}&parameter={idLocality}"
            );
        ...
        private void GetLocalityPollingSections(int idCounty, string idLocality)
        {
            var pollingSectionsTask = HttpClient.GetStringAsync(
                $"http://alegeri.roaep.ro/wp-content/plugins/aep/aep_data.php?name=v1_prez_Sectie_Lista&parameter={Election.Id}&parameter={idLocality}"
            );
        ...
        {
            var pollingSectionsTask = HttpClient.GetStringAsync(
                $"http://alegeri.roaep.ro/wp-content/plugins/aep/aep_data.php?name=v1_prez_Sectie_Sumar&parameter={Election.Id}&parameter={idCounty}&parameter={idPollingSection}"
            );
        ...
        {
            var candidatesDataTask = HttpClient.GetStringAsync(
                $"http://alegeri.roaep.ro/wp-content/plugins/aep/aep_data.php?name=v1_prez_Sectie_Voturi&parameter={Election.Id}&parameter={idCounty}&parameter={idPollingSection}"
            );
